/**
Fonte da ideia:
Ep. 4 - Completing the Game! | Sudoku Game Tutorial using HTML, CSS, and JavaScript.
Produção de RedFlyer Coding. Publicado pelo canal RedFlyer Coding. [S. l.], 2020. 1 videoaula (36 mins. 34 segs.). Youtube.
*/
...
window.onload = function() {
        ...
        //Add event listeener to each number in number container
        for (let i = 0; i < id("number-container").children.length; i++) {
            id("number-container").children[i].addEventListenter("click", function() {
                    ...
                    function startTimer() {
                        ...
                        else if (id("time-2").checked) timeRemainin = 300;
                    ...
                    function generateBoard(board) {
                        ...
                        for (let i = 0; i < 81; i++) {
                            ...
                            //If the tile is not suposed to be blank
                            if (board.charAt(i) != "-") {
